...
export default function Profile() {
    ...
    const menuItems = [
        ...
        { icon: 'M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z', label: 'Advertise', link: '/advertise', color: 'text-purple-500 bg-purple-50' },
    ]
                    ...
                    <Link to="/seller" className="card bg-gradient-to-r from-primary-500 to-primary-600 text-white border-0 shadow-glow">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="font-bold text-sm text-primary-600">Seller Dashboard</h3>
                                    <p className="text-xs text-primary-600">Manage your store & products</p>
                                </div>
                            </div>
